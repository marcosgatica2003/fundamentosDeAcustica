...
tic 
[x fs] = audioread('C:\Users\Bill\Documents\Facultad\6to\Acustica\Señales (signals)\Nativas (anecoicas)\XILOFON.WAV'); % Señal anecoica
x=x(1:1472940).*0.05;
[h fs] = audioread('C:\Users\Bill\Documents\Facultad\6to\Acustica\Tp2\Señales\BRIR-SUM NORES-esw-p1.wav'); % Respuesta impulsiva medida
size=length(h);
hr=h(1:size,1);
hl=h(1:size,2);
yr=conv(x,hr);
